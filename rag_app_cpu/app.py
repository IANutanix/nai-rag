...
with st.sidebar:
    ...
    document_set = st.selectbox(
        ...
        ["employee", "insurance"],
        format_func=lambda x: "Employee Knowledge" if x == "employee" else "Insurance Agency",
        index=0 if st.session_state.document_set == "employee" else 1
    )
...
if (st.session_state.messages and 
    ...
    with st.chat_message("assistant"):
        try:
            ...
            # Add assistant response and update tokens
